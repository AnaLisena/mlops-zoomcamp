...
#step1: 
1) python3 -m venv mlflow_env
2) source mlflow_env/bin/activate && pip install mlflow
3) source mlflow_env/bin/activate && mlflow --version
...
1) source mlflow_env/bin/activate && mlflow server --backend-store-uri sqlite:///mlflow.db --default-artifact-root ./artifacts
